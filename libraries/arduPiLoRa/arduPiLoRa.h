...
the last packet to send/receive.
  ...
  */
    ...
    /*!
   *
  \param uint16_t wait : time to wait while there is no a complete packet
  received.
  \return '0' on success, '1' otherwise
  */
  ...
  */
    ...
    //! It tries to send the packet wich payload is a parameter before ending
    //! MAX_TIMEOUT.
    /*!
  \param uint8_t dest : packet destination.
  \param char *payload : packet payload.
  ...
  */
    ...
    //! It sends the packet wich payload is a parameter before MAX_TIMEOUT, and
    //! replies with ACK.
    /*!
  \param uint8_t dest : packet destination.
  \param char *payload : packet payload.
  ...
  */
    ...
    //! It sends the packet wich payload is a parameter before a timeout, and
    //! replies with ACK.
    /*!
  \param uint8_t dest : packet destination.
  \param char *payload : packet payload.
  ...
  */
    ...
    //! It sends the packet wich payload is a parameter before 'wait' time, and
    //! replies with ACK.
    /*!
  \param uint8_t dest : packet destination.
  \param char *payload : packet payload.
  ...
  */
    ...
    //! It receives and gets an ACK from FIFO, if it arrives before ending 'wait'
    //! time.
    /*!
   *
  ...
  */
    ...
    //! before ending MAX_TIMEOUT time.
    /*!
  \param uint8_t dest : packet destination.
  \param char *payload : packet payload.
  \return '0' on success, '1' otherwise
